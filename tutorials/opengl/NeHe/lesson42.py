...
def Update():
    ...
    if (((mx > (width - 4) or tex_data[(((mx + 2) + (width * my)) * 3)] == 255)) and (
            (mx < 2 or tex_data[(((mx - 2) + (width * my)) * 3)] == 255)) and
            ((my > (height - 4) or tex_data[((mx + (width * (my + 2))) * 3)] == 255)) and (
            (my < 2 or tex_data[((mx + (width * (my - 2))) * 3)] == 255))):
    ...
    if ((dir == 0) and (mx <= (width - 4))):  # // If The Direction Is 0 (Right) And We Are Not At The Far Right
        if (tex_data[
                (((mx + 2) + (width * my)) * 3)] == 0):  # // And If The Room To The Right Has Not Already Been Visited
    ...
    if ((dir == 2) and (mx >= 2)):  # // If The Direction Is 2 (Left) And We Are Not At The Far Left
        if (tex_data[
                (((mx - 2) + (width * my)) * 3)] == 0):  # // And If The Room To The Left Has Not Already Been Visited
            UpdateTex(mx - 1, my);  # // Update The Texture To Show Path Cut Out Between Rooms
    ...
    for loop in xrange(4):  # // Loop To Draw Our 4 Views
        ...
        if (loop == 3):  # // Are We Drawing The Fourth Image?  (3D Texture Mapped Cylinder... Perspective)
            ...
            glTranslatef(0.0, 0.0,
                         -2.0);  # // Translate -2 On The Z-Axis (To Rotate Cylinder Around The Center, Not An End)
